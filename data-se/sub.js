window.TimelineRegistry.registerDataset({
  ...
  facts: [
    ...
    { year: -550, text: '👑 Perserriket växer fram som ett av den gamla världens största imperier.', level: 1 },
    ...
    { year: 1066, text: '🛡️ Normandernas erövring förändrar Englands historia.', level: 1 },
    { year: 1096, text: '✝️ Korstågen inleds.', level: 1 },
    { year: 1206, text: '🐎 Mongolriket börjar växa fram under Djingis khan.', level: 1 },
    ...
    { year: 1453, text: '🕌 Konstantinopel faller för osmanerna.', level: 1 },
    ...
    { year: 1868, text: '🌸 Meijirestaurationen inleder Japans snabba modernisering.', level: 2 },
    { year: 1884, text: '🗺️ Europeiska makter delar upp stora delar av Afrika under imperialismens höjdpunkt.', level: 1 },
